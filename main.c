 ...
 * Author: 佐々木翔
 *
 * Created on 2021/11/07, 11:20
 * Discription　実装試験3の姿勢決定系のプログラム
 * 編集履歴
 * 2021/11/07：初版
 * 
 */
...
volatile char data1[8] = {4, 0, 0, 0, 0, 0, 0, 1};                               //HKデータ
volatile char data2[8] = {4, 0, 0, 0, 0, 0, 0, 2};                               //HKデータ
volatile char data3[8] = {4, 0, 0, 0, 0, 0, 0, 3};                               //HKデータ
volatile char data4[8] = {4, 0, 0, 0, 0, 0, 0, 4};                               //HKデータ
volatile char data5[8] = {4, 0, 0, 0, 0, 0, 0, 5};                               //HKデータ
volatile char data6[8] = {4, 0, 0, 0, 0, 0, 0, 6};                               //HKデータ
